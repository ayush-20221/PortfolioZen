...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "Subject Matter Expert", "Technical Content Writer" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <h1>{`Hi! I'm Ayush Agrawal`} <span className="txt-rotate" dataperiod="1000" data-rotate='[ "Web Developer", "Subject Matter Expert", "Technical Content Writer" ]'><span className="wrap">{text}</span></span></h1>
